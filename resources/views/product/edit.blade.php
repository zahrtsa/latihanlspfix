                ...
                <div class="card-body">
                    <form action="#" method="post">
                        ...
                        <div class="from-group row">
                            ...
                            <input type="text" value="{{ $product->namaproduct }}" name="namaproduct" class="from-control">
                        </div>
                        <div class="from-group row">
                            <label for=""><h5>Price of : </h5></label>
                            <input type="text"  value="{{ $product->harga }}" name="harga" class="from-control">
                        </div>
                        <div class="from-group row">
                            <label for=""><h5>Quantity : </h5></label>
                            <input type="text"  value="{{ $product->qty }}" name="qty" class="from-control">
                        </div>
